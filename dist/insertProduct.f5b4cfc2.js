...
})({"frfQb":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "2d0bbafef5b4cfc2";
"use strict";
...
},{}],"g5O8I":[function(require,module,exports) {
...
$(document).ready(function() {
    ...
    $("#save").on("click", ()=>{
        ...
        const product = new (0, _productDefault.default)(categoryIdCtrl.val(), null, name, description, price, quantity);
        try {
...
},{"regenerator-runtime/runtime":"dXNgZ","./models/Category":"fOVWS","./services/CategoryService":"1bIMI","./constants/FirebaseConstants":"ar8Y5","./models/Product":"b4We3","./services/ProductService":"63Op7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fOVWS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class CategoryService {
    ...
    insertCategory = async (entity)=>{
        const response = await (0, _axiosDefault.default).post(this.realtimeDb + this.collectionName, entity //dữ liệu về phía sever
        );
        const insertedId = await response.data.name;
        return insertedId; //trả về id đc chèn vào reatimedb 
    };
    updateCategory = async (id, entity)=>{
        const response = await (0, _axiosDefault.default).put(`${this.realtimeDb}categories/${id}.json`, entity //thông tin category mới cần update
        );
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b4We3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Product {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"63Op7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["frfQb","g5O8I"], "g5O8I", "parcelRequire090f")

//# sourceMappingURL=insertProduct.f5b4cfc2.js.map
