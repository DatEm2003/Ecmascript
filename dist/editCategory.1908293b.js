...
$(document).ready(function() {
    ...
    const urlHelper = new (0, _urlHelperDefault.default)() //tạo đối tượng từ class urlhelper để lấy giá trị của tham số
    ;
    ...
    $("#update").on("click", ()=>{
        const cate = new (0, _categoryDefault.default)(null, nameCtrl.val());
        try {
...
},{"regenerator-runtime/runtime":"dXNgZ","./models/Category":"fOVWS","./services/CategoryService":"1bIMI","./constants/FirebaseConstants":"ar8Y5","./helpers/UrlHelper":"9C87C","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fOVWS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hoOPg","lnEw9"], "lnEw9", "parcelRequire090f")
